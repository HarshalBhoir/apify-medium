...
# in localhost 127.0.0.1:5000/medium?url=https://medium.com/@sagunshrestha/analyzing-cnets-headlines-3f350bb97cd4
@app.route('/medium')
def medium():
...
def index():
    url = urljoin(request.url_root,
                  "medium?url=https://medium.com/@sagunshrestha/analyzing-cnets-headlines-3f350bb97cd4")
    return jsonify({
